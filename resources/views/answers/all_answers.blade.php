...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body class="bg-light">
		...
		<main>
			...
			<!--	</select>-->
			<!--</form>-->
			<div class="questions container text-center border-gray-300 border-2 rounded-3 mb-5 px-4 py-2 bg-white">
				<div class='question'>
								...
								@auth
									@foreach($answer->users as $user)
										@if (Auth::user()->id == $user->id)
											<div class="d-flex justify-content-between">
												<a type="button" href="/answers/{{ $question->id }}/{{ $answer->id }}/edit_answer" class="mr-1 d-flex justify-content-between btn btn-sm btn-outline-success">
